...
function AboutusComponent() {
  return (
    // <!--about start-->
        ...
        <section className='mx-5 aboutusComponent' id='aboutUsComp'>
        <div class="container">
