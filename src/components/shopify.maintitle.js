...
import {ReactComponent as AboutUs} from '../assets/shopifyMain.svg'
const ShopifyMainTitle = () => {
  ...
  Shopify Development Company
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">Dreamz Shopify Development Company is your go-to e-commerce development partner, specializing in crafting bespoke web stores for businesses and entrepreneurs. Our seasoned team of Shopify experts is equipped to assist you in creating the ideal online store tailored to your unique needs. From complete Shopify store setup to custom theme design, we offer comprehensive solutions to bring your e-commerce vision to life. Trust Dreamz to deliver a standout online shopping experience that drives success for your business.</p>
               </div>
                </div>
            </div>
...
export default ShopifyMainTitle;