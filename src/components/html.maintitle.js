...
const HTMLMainTitle = () => {
  ...
  HTML & CSS Web Designing
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">In the digital era, your online presence is pivotal to success. At Dreamz HTML & CSS Web Designing Company, we excel in creating web experiences that not only make a lasting impression but also yield tangible results. Leveraging our proficiency in HTML and CSS, we transform your digital aspirations into captivating, functional, and user-friendly websites. Trust Dreamz to be your partner in crafting a compelling online presence that resonates with your audience and drives your business forward.</p>
               </div>
                </div>
            </div>
