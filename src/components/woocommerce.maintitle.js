...
import {ReactComponent as AboutUs} from '../assets/wooCommerceMain.svg'
const WoocommerceMainTitle = () => {
  ...
  Woocommerce Development Company
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">At Dreamz, we understand the importance of seamlessly integrating WooCommerce into your online store to unlock its full potential. Our team of skilled developers is adept at harnessing the power of WooCommerce to create robust, feature-rich e-commerce solutions that drive sales and enhance customer satisfaction. With our expertise and attention to detail, we ensure that your WooCommerce-powered store stands out in the competitive online marketplace. Trust Dreamz to be your partner in achieving e-commerce success.</p>
               </div>
                </div>
            </div>
...
export default WoocommerceMainTitle;