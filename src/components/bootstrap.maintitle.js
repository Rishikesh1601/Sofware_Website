...
import {ReactComponent as AboutUs} from '../assets/bootstrapMain.svg'
const BootstrapMainTitle = () => {
  ...
  Bootstrap Web Designing
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">In today's digital landscape, your online presence serves as your digital storefront, making a captivating and user-friendly website essential. At Dreamz Bootstrap Web Designing Company, we specialize in transforming your digital vision into reality. With our proficiency in Bootstrap web design, we are committed to being your trusted partners in crafting websites that captivate, engage, and convert visitors into customers. Trust Dreamz to elevate your online presence and propel your business to new heights.</p>
               </div>
                </div>
            </div>
...
export default BootstrapMainTitle;