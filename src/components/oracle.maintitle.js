...
const OracleMainTitle = () => {
  ...
  Oracle Database Development
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">Dreamz Software Solutions offers comprehensive Oracle Database Administration and Development services tailored to meet diverse business needs. Our expertise spans installation, performance monitoring, database migrations, security management, and utilization of Oracle's features. We ensure high availability with Oracle Real Application Clusters (RAC) and design robust firewalls for enhanced security. Trust us for seamless database solutions that optimize performance and safeguard your valuable data.</p>
               </div>
                </div>
            </div>
...
export default OracleMainTitle;