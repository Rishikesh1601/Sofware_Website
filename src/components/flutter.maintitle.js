...
import {ReactComponent as AboutUs} from '../assets/flutter.svg'
const FlutterMainTitle = () => {
  ...
  Flutter Development Company
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">At Dreamz Flutter Development Company, we're committed to transforming your dreams into tangible reality. Our team of proficient Flutter developers is driven by a passion for crafting exceptional mobile applications that excel in the market. Leveraging our expertise in Flutter, Google's innovative UI framework, we breathe life into your ideas and deliver top-notch, cross-platform solutions that elevate your brand. Trust Dreamz to be your partner in success, guiding you through every step of the journey towards mobile app excellence.</p>
               </div>
                </div>
            </div>
...
export default FlutterMainTitle;