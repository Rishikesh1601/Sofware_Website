...
import {ReactComponent as AboutUs} from '../assets/opencart.svg'
const OpenCartMainTitle = () => {
  ...
  Open Cart Development Company
  </span>
</h1>
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">Dreamz is an open cart development company that specializes in creating custom eCommerce solutions for businesses of all sizes. We offer a wide range of services to help you develop, launch, and manage your online store. Our team of experienced developers can create bespoke features and integrations tailored to your specific needs, as well as provide ongoing support and maintenance. We also provide comprehensive hosting solutions that ensure your store is secure, reliable, and fast-loading. With our expertise in open cart development and our commitment to providing excellent customer service, Dreamz can help you build a successful online business.</p>
               </div>
                </div>
            </div>
...
export default OpenCartMainTitle;