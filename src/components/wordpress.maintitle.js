...
import {ReactComponent as AboutUs} from '../assets/wordpressMain.svg'
const WordPressMainTitle = () => {
  ...
  WordPress Development Company
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">Dreamz is your trusted WordPress development partner, dedicated to crafting bespoke WordPress websites tailored to the unique needs of businesses. Our team comprises experienced and highly skilled WordPress developers who leverage the latest technologies and industry best practices to deliver exceptional results. We offer a comprehensive range of services, including custom theme design and development, plugin development, website optimization, SEO, and more. Trust Dreamz to be your partner in bringing your WordPress vision to life with excellence and precision.</p>
               </div>
                </div>
            </div>
...
export default WordPressMainTitle;