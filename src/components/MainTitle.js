        ...
        <>
            ...
            <div class="">
                ...
                <div class="lg:w-6/12 mt-36">
                    <h1 class="mb-4 text-black text-7xl animate__animated animate__shakeX animate__slow font-bold text-center homePageMainText">Seamless <br></br><span>{dynamicText}</span><br></br> Solutions </h1>
