...
const MSsqlMainTitle = () => {
  ...
  MS Database Development
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">Dreamz SQL Database offers robust, enterprise-grade management for large datasets. Powered by Microsoft SQL Server technology, it ensures blazing-fast data access with advanced security features. With support for stored procedures, query optimization, and Azure integration, it streamlines operations and reduces costs. Seamlessly integrating with Microsoft services like Power BI and Office 365, Dreamz SQL Database provides scalable, cloud-based performance for confident data management.</p>
                    </div>
                </div>
            </div>
