...
import {ReactComponent as AboutUs} from '../assets/dotnetMAin.svg'
const DotNetMainTitle = () => {
  ...
  DotNet Development Company
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">Dreamz provides extensive .NET development services tailored to meet diverse business requirements. Our offerings encompass custom .NET development, seamless integration services, reliable maintenance and support, and expert consulting solutions. Employing a holistic approach to software development, we meticulously analyze clients’ needs, craft bespoke solutions, conduct rigorous testing and deployment, and offer continuous maintenance and support. Partner with Dreamz for top-notch .NET solutions that drive business success.</p>
               </div>
                </div>
            </div>
...
export default DotNetMainTitle;