...
import {ReactComponent as TeamAug} from '../assets/Images/team augmentation 1.svg'
import './card.css'
    ...
    // <!--about start-->
        ...
        <div class="container">
            ...
            <div class="lg:w-1/2 md:w-full mt-6 lg:mt-0 lg:pl-10">
                ...
                <p class="mb-5 text-lg text-gray-400 paraAboutus text-justify">Elevate your projects with Dreamz's dedicated development team. Hire skilled developers, designers, and testers to swiftly design, build, deliver, and scale your idea. Tailor your team to meet the changing needs of your enterprise IT or bring your unique concept to life from scratch. Save costs, accelerate app time-to-market, and streamline hiring with our qualified and experienced professionals. Stop recruitment hassles and start developing with Dreamz's dedicated teams.</p>
            </div>
