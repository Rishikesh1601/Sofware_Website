...
const products = [
  ...
  { name: 'AIops Solutions',  href: '#', icon: CpuChipIcon },
      ...
      <nav className="mx-auto flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            ...
            <img className="h-16 w-18 mainlogo" src="http://dreamztechnologies.com/assets/uploads/logos/logo_transperant.png" alt="Dreamz" />
          </a>
        </div>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12 allHead">
        ...
        <div class="card">
          <a class="socialContainer containerOne" href="https://www.instagram.com/dreamztechnology/" target='blank'>
          ...
          <a class="socialContainer containerTwo" href="https://twitter.com/dreamz_tech" target='blank'>
          <svg className='logo-twitter' xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg>                    </a>
            
          <a class="socialContainer containerThree" href="https://www.linkedin.com/company/dreamztechnology/" target='blank'>
          ...
          <a class="socialContainer containerFour" href="https://wa.me/9960689666" target='blank'>
