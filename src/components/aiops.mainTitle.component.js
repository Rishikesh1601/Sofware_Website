...
import {ReactComponent as AiOps} from '../assets/Images/aiops.svg'
const AIopsMainTitle = () => {
            ...
            <div class="container">
                ...
                <div class="lg:w-6/12 order-lg-1">
                    ...
                    <div class="mt-7 rounded box-shadow relative ">
                        <AiOps className="w-96 h-auto heropngEdit -mt-11"/>
                    </div>
                    </div>
                </div>
  ...
  Artificial Intelligence for IT Operations
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">Dreamz Artificial Intelligence for IT Operations (DAIO) is a cloud-based solution designed to help IT teams optimize and automate operations. DAIO uses artificial intelligence and machine learning to monitor, manage and learn from existing IT systems, enabling teams to quickly detect and resolve issues, automate routine tasks and proactively prevent potential problems. DAIO can be used to reduce the time required for managing IT infrastructure and ensure that IT teams are able to respond to changing demands quickly and efficiently.</p>
                </div>
                </div>
            </div>
