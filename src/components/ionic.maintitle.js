...
import {ReactComponent as AboutUs} from '../assets/ionicMAin.svg'
const IonicMainTitle = () => {
  ...
  Ionic Development Company
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">Welcome to the forefront of cross-platform mobile app development. At Dreamz Ionic Development Company, we are the visionaries behind your mobile app aspirations. Specializing in Ionic framework development, we excel in creating robust, high-performance mobile applications that effortlessly operate across various platforms. Trust Dreamz to be your partner in transforming your mobile app dreams into reality.</p>
               </div>
                </div>
            </div>
