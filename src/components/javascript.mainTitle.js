...
import {ReactComponent as AboutUs} from '../assets/JavascriptMain.svg'
const JavascriptMainTitle = () => {
  ...
  Javascript Web Designing
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">In the ever-evolving digital landscape, your website serves as more than just a digital presence—it embodies your brand's voice, acts as a powerful tool for engagement, and serves as the gateway to your success. At Dreamz JavaScript Web Designing Company, we transcend traditional web design—we are digital architects who specialize in crafting immersive web experiences that captivate, engage, and convert visitors into loyal customers.</p>
               </div>
                </div>
            </div>
...
export default JavascriptMainTitle;