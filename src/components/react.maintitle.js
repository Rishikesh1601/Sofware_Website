...
import {ReactComponent as AboutUs} from '../assets/reactmain.svg'
const ReactMainTitle = () => {
  ...
  React Development Company
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">React's component-based architecture allows for the creation of reusable UI elements, which promotes code reusability and maintainability. Additionally, React's virtual DOM enables efficient updates to the user interface, resulting in improved performance and a smoother user experience. These features, combined with React's strong community support and ecosystem of libraries and tools, make it a compelling choice for building modern web and mobile applications.</p>
               </div>
                </div>
            </div>
