...
import {ReactComponent as AboutUs} from '../assets/laravelMain.svg'
const LaravelMainTitle = () => {
  ...
  Laravel Development Company
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">Dreamz is a full-service web development company that specializes in Laravel development. We have a team of experienced and certified developers who have been working with Laravel since its early days. Our developers have built a variety of applications ranging from basic websites to complex enterprise solutions. We use the latest technologies and tools to ensure that our projects are of the highest quality and most secure. We are committed to developing applications that are user-friendly, secure, and scalable. We understand the importance of staying up-to-date with the latest trends in web development and actively stay informed about the advancements in the Laravel framework.</p>
               </div>
                </div>
            </div>
...
export default LaravelMainTitle;