...
const CodeIgniterMainTitle = () => {
  ...
  Code Igniter Development Company
  </span>
</h1>
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">Dive into a realm of unparalleled web development prowess with Dreamz. Our adept team of CodeIgniter experts is dedicated to delivering cutting-edge solutions that elevate your online presence. With a keen eye for detail and a commitment to excellence, we craft bespoke web applications that resonate with your audience and drive tangible results. Experience the power of CodeIgniter with Dreamz, where innovation meets expertise.</p>
               </div>
                </div>
            </div>
...
export default CodeIgniterMainTitle;