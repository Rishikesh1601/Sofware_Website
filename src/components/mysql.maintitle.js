...
import {ReactComponent as AboutUs} from '../assets/database1.svg'
const MySqlMainTitle = () => {
  ...
  MySQL Database Development
                    ...
                    <p class="text-gray-600 font-bold text-justify ms-11 text-lg mb-5 animate__animated animate__zoomIn animate__slow">Dreamz is a premier company renowned for its MySQL development services. With a seasoned team of experts, we specialize in crafting optimized database solutions tailored to diverse business needs. Our services encompass designing, developing, and implementing custom MySQL databases that prioritize efficiency, security, and reliability. Additionally, we provide comprehensive support for data migration, backup, query optimization, stored procedure development, and performance tuning. Tailored to individual client requirements, our services guarantee powerful databases with unparalleled performance.</p>
               </div>
                </div>
            </div>
